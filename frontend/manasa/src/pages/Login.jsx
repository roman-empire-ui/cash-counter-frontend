...
const Login = () => {
  ...
  return (
    <div
    className="relative min-h-screen w-full bg-no-repeat bg-cover bg-center bg-gray-300 flex items-center justify-center p-4"
    style={{
  ...
  >
    {/* ✅ Full-screen Lottie loading overlay */}
    {loading && (
      <div className="absolute inset-0 bg-black/70 flex flex-col items-center justify-center z-50">
        <Lottie animationData={welcome} loop autoplay className="w-52 h-52" />
    ...
    <div className="bg-white/30 backdrop-blur-md shadow-md rounded-lg p-8 w-full max-w-md relative z-10">
